 ...
 *  - `OPENTRATTOS_AGENT_HACCP_RECORD_CCP_READING_ENABLED`
 *  - `OPENTRATTOS_AGENT_HACCP_RECORD_CORRECTIVE_ACTION_ENABLED`
 *  - `OPENTRATTOS_AGENT_HACCP_CONFIGURE_FSMS_STANDARDS_ENABLED`
 */
